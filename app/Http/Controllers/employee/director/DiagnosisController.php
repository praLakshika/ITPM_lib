...
class DiagnosisController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('employee.director.diagnosis.index',compact('diagnosise') );
    ...
    {
        return view('employee.director.diagnosis.add');
    }
    /**
    ...
    //     return ;
         ...
         return view('employee.director.diagnosis.success');
    }
    public function update(DiagnosisValUpdate $request,Diagnosis $diagnosise)
    {
        ...
        //   return $diagnosis;
          foreach($diagnosise as $diagnosis)
          {
              ...
              return redirect()->intended(route('employee.director.diagnosis.edit',[$diagnosis->id]))->with('message', $message);
              }
          }
    ...
    {
        return view('employee.director.diagnosis.show',['diagnosis' => $diagnosis]);
    }
    /**
    ...
    {
        return view('employee.director.diagnosis.edit',['diagnosis' => $diagnosis]);
    }
    ...
    {
        return view('employee.director.diagnosis.delete',['diagnosis' => $diagnosis]);
    }
}