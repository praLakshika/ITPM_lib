    ...
    <div class="left_col scroll-view">
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li class="<?php if(Request::is('admin/member') || Request::is('admin/searchMember') || Request::is('admin/member/'.$emp)): ?> active <?php endif; ?>">
                    ...
                    <li class="<?php if(Request::is('admin/online_book/add') ||Request::is('admin/searchonline_book')): ?> active <?php endif; ?>">
