    ...
    <div class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <form action="editpat" method="post">
            ...
            <div class="form-group">
                    ...
                    <textarea class="form-control" name="address" id="address" cols="30" rows="10" placeholder="Patient Address"> <?php echo e($patient->address); ?></textarea>
                  </div>
            ...
            <a href="<?php echo e(route('admin.patients')); ?>" class="btn btn-danger">Cancel</a>
        </form>
    </div>
