...
<?php $__env->startSection('content'); ?>
    <div class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        ...
        <div class="form-group">
            <?php echo Form::open(array('route' => 'admin.appointments.checkDate')); ?>
        ...
        <?php echo Form::open(array('route' => 'admin.appointments.checkDate.store')); ?>
            ...
            <div class="form-group">
                ...
                <?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Patient Name']); ?>
