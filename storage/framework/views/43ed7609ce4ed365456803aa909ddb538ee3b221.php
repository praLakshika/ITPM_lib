    ...
    <div class="row">
        <table  class="table table-striped table-bordered dt-responsive nowrap"  cellspacing="0" width="100%" border="0">
            ...
            <tr>
                    ...
                    <div class="demptable">
                        <?php echo e(link_to_route('admin.author.add', 'Add author', null, ['class' => 'btn btn-primary'])); ?>
        ...
        <?php endif; ?>
            ...
            <div class="col-xs-6 col-sm-3">
                <div class="dcard">
                    ...
                    <div class="dcard-body text-center">
                        <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.author.show',[$Book_author->id])); ?>">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.author.edit',[$Book_author->id])); ?>">
                            <i class="fa fa-pencil"></i>
                        </a>
                        <a class="btn btn-xs btn-danger" href="<?php echo e(route('admin.author.delete',[$Book_author->id])); ?>">
