...
<form action="updatestore" method="post">
    ...
    <?php endif; ?>
        <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="name" value="<?php echo e($stores->iteamname); ?>">
              </div>
        <div class="form-group">
          <label for="quantity">Item quantity *</label>
          <input type="text" class="form-control"name="quantity" id="quantity" value="<?php echo e($stores->iteam_quantity); ?>">
        </div>
        <div class="form-group">
            <label for="max">Item maximum *</label>
            <input type="text" class="form-control"name="max" id="max" value="<?php echo e($stores->iteam_max); ?>">
          </div>
          <div class="form-group">
              <label for="min">Item minimum *</label>
              <input type="text" class="form-control"name="min" id="min" value="<?php echo e($stores->iteam_min); ?>">
            </div>
