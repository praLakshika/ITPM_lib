    ...
    <div class="row">
        <table  class="table table-striped table-bordered dt-responsive nowrap"  cellspacing="0" width="100%" border="0">
            ...
            <tr>
                    ...
                    <div class="demptable">
                        <a href="<?php echo e(route('admin.book.add')); ?>" class="btn btn-primary">Add Book</a>
        ...
        ?>
            ...
            <div class="col-xs-6 col-sm-3">
                <div class="dcard">
                    ...
                    <div class="dcard-body text-center">
                        <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.book.show',[$Book->id])); ?>">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.book.edit',[$Book->id])); ?>">
                            <i class="fa fa-pencil"></i>
                        </a>
                        <a class="btn btn-xs btn-danger" href="<?php echo e(route('admin.book.delete',[$Book->id])); ?>">
