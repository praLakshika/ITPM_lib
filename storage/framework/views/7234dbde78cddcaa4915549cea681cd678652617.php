<?php $__env->startSection('content'); ?>
    ...
    <div class="row tile_count">
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div class="count green"><?php echo e($counts['patient']); ?></div>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-users"></i>Total Employees</span>
            <div class="count green"><?php echo e($counts['employees']); ?></div>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-users"></i>Total Doctors</span>
            <div class="count green"><?php echo e($counts['doctor']); ?></div>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user-times "></i>Appointments</span>
            <div>
                <span class="count green"><?php echo e($counts['appointment'] - $counts['users_inactive']); ?></span>
        ...
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div>
                <span class="count green"><?php echo e($counts['question']); ?></span>
            </div>
        </div>
    <!-- /top tiles -->
