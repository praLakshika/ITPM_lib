        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you really want to delete questions forum  id <?php echo e($questionsforum->id); ?>? This process cannot be undone.</p>
                </div>
                <div class="modal-footer">
                        <a href="<?php echo e(route('admin.question_forum')); ?>" class="btn btn-primary">Cancel</a>
