<?php $__env->startSection('content'); ?>
    <div class="row title-section">
        ...
        <div class="col-8 col-md-4" style="padding-bottom: 15px;">
            <div class="topicbar">
                <a href="<?php echo e(route('doctor.question_forum.add')); ?>" class="btn btn-primary">Add Question</a>
            </div>
                ...
                <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                    ...
                    <?php $__currentLoopData = $questionsforum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $questionsforum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-xs btn-primary" href="<?php echo e(route('doctor.question_forum.show',[$questionsforum->id])); ?>">
                                    <i class="fa fa-eye"></i>
                                </a>
