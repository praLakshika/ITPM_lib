...
<div class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
    ...
    <?php echo e(Form::open(['route'=>['admin.employees.update', $employee->id],'method' => 'put','class'=>'form-horizontal form-label-left', 'enctype'=>"multipart/form-data"])); ?>
        ...
        <div class="form-group">
            ...
            <?php echo Form::email('email',  $employee->email, ['class' => 'form-control', 'placeholder'=>'Valid email']); ?>

        </div>
        <div class="form-group">
            <?php echo Form::label('contactNo', 'Contact Number'); ?>

            <?php echo Form::text('contactNo',  $employee->contactNo, ['class' => 'form-control', 'placeholder'=>'Mobile number']); ?>
