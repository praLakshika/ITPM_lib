    ...
    <div class="row title-section">
        ...
        <div class=".col-xs-6 .col-lg-4 searchbar-addbt">
            <div class="topicbar">
                ...
                <?php echo e(link_to_route('director.employees.add', 'Add Employee', null, ['class' => 'btn btn-primary'])); ?>
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <?php echo Form::open(array('route' => ['director.employees.delete', $employee->id], 'method' => 'DELETE', 'onSubmit'=> 'return confirm("Do you really want to delete?");')); ?>

                                <a href="<?php echo e(route('director.employees.show', [$employee->id])); ?>" class="btn btn-link">View</a>
                                <a href="<?php echo e(route('director.employees.edit', [$employee->id])); ?>" class="btn btn-success">Update</a>
