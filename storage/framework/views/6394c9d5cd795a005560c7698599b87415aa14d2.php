        ...
        <?php endif; ?>
            ...
            <div class="col-xs-6 col-sm-3">
                <div class="dcard">
                    ...
                    <div class="dcard-body text-center">
                        <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.member',[$Book_author->id])); ?>">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.member',[$Book_author->id])); ?>">
                            <i class="fa fa-pencil"></i>
                        </a>
                        <a class="btn btn-xs btn-danger" href="<?php echo e(route('admin.member.delete',[$Book_author->id])); ?>">
