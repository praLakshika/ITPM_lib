<?php $__env->startSection('content'); ?>
    <div class="row title-section">
        ...
        <div class="col-12 col-md-12">
            <a href="<?php echo e(route('admin.financial.IncomeReport')); ?>" class="btn btn-success">Income Report</a>
            <a href="<?php echo e(route('admin.financial.OutcomeReport')); ?>" class="btn btn-primary">Outcome Report</a>
