...
<div class="form-group">
    ...
    <input type="hidden" id="qu_Ask" name="qu_Ask" value="<?php echo e($IDpa); ?>">
        <a href="<?php echo e(route('patient.question_forum')); ?>" class="btn btn-danger">Cancel</a>
        <a href="<?php echo e(route('patient.question_forum.add')); ?>" class="btn btn-primary">Clear</a>
