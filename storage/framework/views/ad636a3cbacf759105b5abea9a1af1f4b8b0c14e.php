        ...
        <?php endif; ?>
            ...
            <div class="col-xs-6 col-sm-3">
                <div class="dcard">
                    ...
                    <div class="dcard-body text-center">
                        <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.member.show',[$member->id])); ?>">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.member.edit',[$member->id])); ?>">
